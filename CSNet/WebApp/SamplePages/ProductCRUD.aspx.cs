...
namespace WebApp.NorthwindPages
{
    public partial class ProductCRUD : System.Web.UI.Page
    {
        ...
        protected void UpdateProduct_Click(object sender, EventArgs e)
        {
            ...
            //on the update, you must have the pkey of the record
            ...
            else
            {
                ...
                try
                {
                    ...
                    //in addition to the non-pkey fields being accessed and 
                    //   loaded, the pkey value MUST also be loaded
                    ...
                    //during an update, you need to take the actual value that
                    //    is in the field
                    ...
                    if (rowsaffected == 0)
                    {
                        errormsgs.Add(ProductName.Text + " has not been updated. Search for the product again."); LoadMessageDisplay(errormsgs, "alert alert-warning");
                        BindProductList();
                    }
                    else
                    {
        ...
        {
            //on the delete, you must have the pkey of the record
            //    that is being processed
            if (string.IsNullOrEmpty(ProductID.Text.Trim()))
            {
                errormsgs.Add("Search for the product you wish to maintain.");
            ...
            {
                //assume your validation is successful and you can
                //   proceed with deleting the data to the database
                //try/catch
                try
                {
                    //connect to the appropriate BLL controller for <T>
                    ...
                    if (rowsaffected == 0)
                    {
                        errormsgs.Add(ProductName.Text + " has not been processed. Search for the product again.");
                    ...
                    else
                    {
                        ...
                        LoadMessageDisplay(errormsgs, "alert alert-success");
                        BindProductList();
                        //dependent on whether the record is a physical or logical 
                        //    delete
